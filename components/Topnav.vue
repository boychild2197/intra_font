    ...
    <v-menu offset-y>
        ...
        >
          <v-chip link>
            <v-badge dot bottom offset-x="10" offset-y="10" color="green">
              <v-avatar size="40">
                <v-img src="../assets/images/profile2.jpeg" alt=""></v-img>
              </v-avatar>
            </v-badge>
            <span class="mx-2">Gervas Mshamu</span>
          </v-chip>
        </span>
      </template>
      <v-list width="250" class="py-0">
        <v-list-item two-line>
          <v-list-item-avatar>
            <v-img src="../assets/images/profile2.jpeg"></v-img>
          </v-list-item-avatar>
          <v-list-item-content>
            <v-list-item-title> Gervas Mshamu </v-list-item-title>
